...
const a = `events_acuity_cavern.json
...
events_battle_frontier_gate_to_fight_area.j
...
events_contest_hall_stage_ongoing_contest.j
...
events_eterna_city_underground_man_house.js
...
events_gate_between_eterna_city_route_206.j
...
events_grand_lake_valor_lakefront_east_hous
events_grand_lake_valor_lakefront_west_hous
...
events_hearthome_city_dp_gym_elevator_room_
events_hearthome_city_dp_gym_elevator_room_
events_hearthome_city_dp_gym_leader_room.js
...
events_hearthome_city_east_gate_to_amity_sq
events_hearthome_city_gym_entrance_room.jso
events_hearthome_city_gym_leader_room.json
events_hearthome_city_gym_trainer_room_1.js
events_hearthome_city_gym_trainer_room_2.js
events_hearthome_city_mart.json
events_hearthome_city_northeast_house_1f.js
events_hearthome_city_northeast_house_2f.js
events_hearthome_city_northeast_house_eleva
...
events_hearthome_city_southeast_house_1f.js
events_hearthome_city_southeast_house_2f.js
events_hearthome_city_southeast_house_eleva
events_hearthome_city_west_gate_to_amity_sq
...
events_jubilife_city_southwest_house_1f.jso
events_jubilife_city_southwest_house_2f.jso
...
events_jubilife_tv_3f_global_ranking_room.j
events_jubilife_tv_3f_group_ranking_room.js
...
events_old_chateau_back_middle_east_room.js
events_old_chateau_back_middle_room.json
events_old_chateau_back_middle_west_room.js
...
events_oreburgh_city_northwest_house_1f.jso
events_oreburgh_city_northwest_house_2f.jso
events_oreburgh_city_northwest_house_3f.jso
events_oreburgh_city_northwest_house_4f.jso
...
events_pastoria_city_observatory_gate_1f.js
events_pastoria_city_observatory_gate_2f.js
...
events_pokemon_league_elevator_to_aaron_roo
events_pokemon_league_elevator_to_bertha_ro
events_pokemon_league_elevator_to_champion_
events_pokemon_league_elevator_to_flint_roo
events_pokemon_league_elevator_to_hall_of_f
events_pokemon_league_elevator_to_lucian_ro
events_pokemon_league_flint_room.json
events_pokemon_league_hall_of_fame.json
events_pokemon_league_lucian_room.json
events_pokemon_league_north_pokecenter_1f.j
events_pokemon_league_north_pokecenter_2f.j
events_pokemon_league_north_pokecenter_b1f.
events_pokemon_league_south_pokecenter_1f.j
events_pokemon_league_south_pokecenter_2f.j
...
events_resort_area_ribbon_syndicate_elevato
...
events_route_206_cycling_road_north_gate.js
events_route_206_cycling_road_south_gate.js
events_route_207.json
events_route_208.json
events_route_208_gate_to_hearthome_city.jso
events_route_208_house.json
events_route_209.json
events_route_209_gate_to_hearthome_city.jso
...
events_route_212_gate_to_hearthome_city.jso
...
events_route_214_gate_to_veilstone_city.jso
events_route_215.json
events_route_215_gate_to_veilstone_city.jso
...
events_route_222_gate_to_sunyshore_city.jso
...
events_sandgem_town_counterpart_house_1f.js
events_sandgem_town_counterpart_house_2f.js
...
events_sandgem_town_pokemon_research_lab.js
...
events_solaceon_ruins_maniac_tunnel_room.js
events_solaceon_ruins_room_1.json
events_solaceon_ruins_room_1_northwest_dead
events_solaceon_ruins_room_1_southeast_dead
events_solaceon_ruins_room_2.json
events_solaceon_ruins_room_2_northeast_dead
events_solaceon_ruins_room_2_southeast_dead
events_solaceon_ruins_room_3.json
events_solaceon_ruins_room_3_northwest_dead
events_solaceon_ruins_room_3_southwest_dead
events_solaceon_ruins_room_4.json
events_solaceon_ruins_room_4_southeast_dead
events_solaceon_ruins_room_5.json
events_solaceon_ruins_room_5_southeast_dead
events_solaceon_ruins_room_5_southwest_dead
events_solaceon_ruins_room_6.json
events_solaceon_ruins_room_6_northwest_dead
events_solaceon_ruins_room_6_southeast_dead
...
events_solaceon_town_pokemon_news_press.jso
...
events_team_galactic_eterna_building_1f.jso
events_team_galactic_eterna_building_2f.jso
events_team_galactic_eterna_building_3f.jso
events_team_galactic_eterna_building_4f.jso
...
events_veilstone_city_galactic_warehouse.js
...
meson.build
zone_event.order`.split('\n').filter(a => a.includes('.json'))

let list = [];
for(let i = 0 ; i < a.length; i++){
  const p = `C:\\Users\\Samuel\\source\\repos\\pokeplatinum\\res\\field\\events\\` + a[i];
  const json = JSON.parse(fs.readFileSync(p, 'utf8'));
  json.object_events.forEach(b => {
    if (b.script >= 3000 && b.script < 4000){
      list.push(`{"id":"${b.script - 3000 + 1}","location":"${a[i]}"},`);
    }
  });
}
